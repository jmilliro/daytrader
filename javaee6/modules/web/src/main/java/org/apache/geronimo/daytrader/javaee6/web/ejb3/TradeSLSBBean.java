...
public class TradeSLSBBean implements TradeSLSBRemote, TradeSLSBLocal {
    ...
    @Resource(name = "jms/TradeStreamerTopic", mappedName = "jms/TradeStreamerTopic")
    private Topic tradeStreamerTopic;

    @Resource(name = "jms/TradeBrokerQueue", mappedName = "jms/TradeBrokerQueue")
    ...
    public Collection<OrderDataBean> getClosedOrders(String userID) {
        ...
        try {
            ...
            if (TradeConfig.jpaLayer == TradeConfig.HIBERNATE) {
                ...
                Query updateStatus = entityManager.createNativeQuery("UPDATE orderejb SET orderStatus = 'completed' WHERE orderStatus = 'closed' AND ACCOUNT_ACCOUNTID  = ?");
